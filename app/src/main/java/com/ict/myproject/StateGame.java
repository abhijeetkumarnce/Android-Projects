...
public class StateGame extends AppCompatActivity {
    ...
    String[] dictionary = {"BIHAR", "JHARKHAND", "MAHARASHTRA", "DELHI", "ASSAM", "KARNATAKA", "KERALA", "TELANGANA", "CHANDIGARH", "HARYANA"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_state_game);
