...
public class CityGame extends AppCompatActivity {
    ...
    String[] dictionary = {"AGRA", "BHOPAL", "CHENNAI", "DELHI", "GAYA", "GOA", "KOLKATA", "MYSORE", "MUMBAI", "PATNA"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_city_game);
